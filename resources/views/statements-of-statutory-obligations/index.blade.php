<x-app-layout>
    <x-dashboard-header title="Statements of Statutory Obligations" subtitle="Manage categories and statutory obligation items by fiscal year." />

    <div class="max-w-7xl mx-auto p-6">
        <div class="flex justify-between items-center mb-6">
            <div></div>
            <x-primary-button onclick="window.location.href='{{ route('statements-of-statutory-obligations.create') }}'">Create Record</x-primary-button>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 mb-6">
            <form method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="flex items-end gap-2">
                    ...
                    <x-secondary-button onclick="window.location.href='{{ route('statements-of-statutory-obligations.index') }}'">Clear</x-secondary-button>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-sm">
                                <div class="flex gap-2">
                                    <a href="{{ route('statements-of-statutory-obligations.show', $record) }}" class="text-blue-600 hover:text-blue-700">View</a>
                                    <a href="{{ route('statements-of-statutory-obligations.edit', $record) }}" class="text-yellow-600 hover:text-yellow-700">Edit</a>
                                    <form method="POST" action="{{ route('statements-of-statutory-obligations.destroy', $record) }}" onsubmit="return confirm('Delete this record?')">
                                        @csrf
                                        @method('DELETE')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            btn.addEventListener('click', function () {
                ...
                const url = new URL('{{ route('statements-of-statutory-obligations.print-fiscal-year') }}', window.location.origin);
