...
class SalaryScheduleAnnexA2026Seeder extends Seeder
{
    public function run(): void
    {
        $fiscalYear = FiscalYear::firstOrCreate(
            ['year' => 2026],
            FiscalYear::generateForYear(2026)
        );
        ...
        $schedule = SalarySchedule::updateOrCreate(
            [
                ...
                'title' => 'Third Tranche Monthly Salary Schedule (Annex A)',
            ],
            [
                'notes' => 'Seeded from user-provided Annex A image. Row 33 values beyond Step 2 are not visible in the screenshot and were left blank.',
                'total_steps' => 8,
                'max_grade' => 33,
            ]
        );

        $schedule->cells()->delete();
        ...
        $rows = [
            ...
            17 => [1 => 49652, 2 => 50066, 3 => 50576, 4 => 51092, 5 => 51614, 6 => 52144, 7 => 52678, 8 => 53221],
            18 => [1 => 53818, 2 => 54371, 3 => 54933, 4 => 55499, 5 => 56075, 6 => 56657, 7 => 57246, 8 => 57842],
            19 => [1 => 59153, 2 => 59666, 3 => 60793, 4 => 61632, 5 => 62486, 6 => 63353, 7 => 64236, 8 => 65132],
            20 => [1 => 66052, 2 => 66970, 3 => 67904, 4 => 68853, 5 => 69818, 6 => 70772, 7 => 71727, 8 => 72671],
            21 => [1 => 73303, 2 => 74337, 3 => 75388, 4 => 76456, 5 => 77542, 6 => 78645, 7 => 79769, 8 => 80831],
            ...
            33 => [1 => 449157, 2 => 462329, 3 => null, 4 => null, 5 => null, 6 => null, 7 => null, 8 => null],
        ];

        foreach ($rows as $grade => $steps) {
            foreach ($steps as $step => $amount) {
                if ($amount === null) {
                    continue;
                }

                $schedule->cells()->create([
                    'salary_grade' => $grade,
                    'step_no' => $step,
                    'amount' => $amount,
                ]);
